...
def _triton_sparse_attn_decode_optimized(
    ...
    d_qk: int, fused_gather_fn, gather_fn,
) -> Tuple[torch.Tensor, torch.Tensor]:
    ...
    if kv_quantized_main is not None and has_extra_quantized:
        # Fused path (MODEL1 with extra_kv_scope)
        ...
        # Single gather path (V3.2 or MODEL1 without extra)
